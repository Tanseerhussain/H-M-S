...
import { Users, Building, AlertCircle, TrendingUp, TrendingDown, DollarSign } from "lucide-react"

const occupancyData = [
  { name: "Green Valley", occupied: 38, total: 50, percentage: 76 },
  { name: "Sunrise Residence", occupied: 32, total: 40, percentage: 80 },
...
export default function Analytics() {
  ...
  const averageOccupancy = Math.round(
    occupancyData.reduce((sum, item) => sum + item.percentage, 0) / occupancyData.length,
  )
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Comprehensive overview of hostel management metrics</p>
        </div>
                ...
                <BarChart data={occupancyData}>
                  ...
                  <Tooltip
                    formatter={(value, name) => [
                      name === "occupied" ? `${value} occupied` : `${value} total`,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Academic year-wise student count</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex flex-col lg:flex-row items-center gap-6">
                <div className="w-64 h-64">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-green-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-green-700">₹{(totalRevenue / 100000).toFixed(1)}L</p>
              </div>
              ...
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-2xl font-bold text-blue-700">₹{(netProfit / 100000).toFixed(1)}L</p>
              </div>
            </div>
          </CardContent>
        </Card>
