        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 text-center lg:text-left">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-center lg:justify-start space-x-2 mb-4">
              <div className="bg-secondary p-2 rounded-lg shadow-md transition-transform duration-300 hover:scale-110 hover:shadow-lg">
            ...
            <p className="text-primary-foreground/80 mb-4 leading-relaxed text-base">
              ...
              Making hostel life seamless for students, efficient for wardens,
              and comprehensive for administrators.
            </p>
            ...
            <div>
              <p className="text-sm font-semibold mb-2 text-primary-foreground/90">
                Follow Us
              </p>
              <div className="flex justify-center lg:justify-start space-x-2">
                {["📘", "🐦", "📷", "💼"].map((icon, i) => (
                  <div
                    key={i}
                    className="bg-primary-foreground/10 hover:bg-secondary p-2 rounded-md cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-md"
                  >
                    <span>{icon}</span>
                  </div>
                ))}
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={i}>
                  <a
                    href={link.href}
                    className="text-primary-foreground/80 hover:text-secondary transition-all duration-300 flex items-center justify-center lg:justify-start group text-sm hover:translate-x-1"
                  >
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start justify-center lg:justify-start space-x-2 text-primary-foreground/80 text-sm">
                <div className="bg-secondary/20 p-2 rounded-md shadow-sm transition-transform duration-300 hover:scale-110 hover:shadow-md">
            ...
            <div className="mt-3 p-4 w-full bg-primary-foreground/5 rounded-lg border border-secondary/20 shadow-md text-sm transition-transform duration-300 hover:scale-105 hover:shadow-lg">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 text-sm text-primary-foreground/60 text-center md:text-left">
              ...
              <div className="flex items-center gap-4">
                <a
                  href="#"
                  className="hover:text-secondary transition-colors duration-300 hover:underline"
                >
                  Privacy Policy
                </a>
                <span>•</span>
            ...
            {/* Right Section */}
            <div className="text-sm text-primary-foreground/60 text-center md:text-right transition-transform duration-300 hover:scale-105 hover:text-secondary">
